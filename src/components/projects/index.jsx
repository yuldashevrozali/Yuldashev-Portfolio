    ...
    <div className="projects-container">
      ...
      <div className="projects-blocks">
        <div className="project-block1">
          <a
            href="https://imtihon7-six.vercel.app/"
            target="_blank"
        ...
        <div className="project-block">
          ...
          <h3>online shop</h3>
          <p>
            This site is an online store that has a variety of products. You can
            buy the products by selecting them and adding them to the cart
          </p>
        </div>
        <div className="project-block1">
          <a
            href="https://cryptofolioweb.netlify.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="project-image-container">
        ...
        <div className="project-block1">
          <a
            href="https://3-homewrok.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="project-image-container">
        ...
        <div className="project-block1">
          <a
            href="https://quiz-9-dars.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="project-image-container">
        ...
        <div className="project-block1">
          <a
            href="https://tarix-pedagogika.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="project-image-container">
              <img src={history} alt="Project" className="project-image" />
              <div className="hover-overlay">
                <span className="hover-text">➔</span>
              </div>
            </div>
        ...
        <div className="project-block">
          ...
          <h3>History Quiz</h3>
          <p>
            History Pedagogy Practice Tests Prepare for certification with:
            Focused Practice Tests, Real Exam Simulations, Expert Tips. Start now
